...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="text-white mb-5" style="text-align:center">Register</h1>
    ...
    <div class="d-flex flex-wrap justify-content-center">
        <div class="text-white border border-2 d-flex flex-column align-items-center p-3" style="width: 18rem">
            ...
            <asp:Button ID="regisBtn" runat="server" Text="Register" OnClick="regisBtn_Click" class="btn btn-success"/>
        </div>
    </div>
